...
export default function BackgroundSlideshow() {
    ...
    return (
        <View style={styles.container}>
            {/* Single CrossfadeImage for the background to avoid double re-mounts */}
            <CrossfadeImage
                style={styles.fill}
                source={images[index]}
                resizeMode="cover"
                ...
                duration={1000}
            >
                {/* <View style={styles.content}> <CrossfadeImage style={styles.image} source={images[index]} resizeMode="cover" /></View> */}
            </CrossfadeImage>
        </View>
    );
}
...
const styles = StyleSheet.create({
    content: { margin: 30, height: "100%", alignItems: 'center', justifyContent: 'center' }, image: { width: '100%', aspectRatio: 1, borderRadius: 10, },
